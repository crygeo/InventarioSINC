...
public partial class ChangePassDialog : UserControl, IDialog
{
    public static readonly DependencyProperty AceptarCommandProperty =
        DependencyProperty.Register(nameof(AceptarCommand), typeof(IAsyncRelayCommand), typeof(ChangePassDialog));

    public static readonly DependencyProperty CancelCommandProperty =
        DependencyProperty.Register(nameof(CancelCommand), typeof(IAsyncRelayCommand), typeof(ChangePassDialog));

    public static readonly DependencyProperty OldPasswordProperty = DependencyProperty.Register(nameof(OldPassword),
        typeof(string), typeof(ChangePassDialog), new PropertyMetadata(""));

    public static readonly DependencyProperty NewPasswordProperty =
        DependencyProperty.Register(nameof(NewPassword), typeof(string), typeof(ChangePassDialog));

    public static readonly DependencyProperty ConfirmPasswordProperty =
        DependencyProperty.Register(nameof(ConfirmPassword), typeof(string), typeof(ChangePassDialog));

    public static readonly DependencyProperty OldPasswordRequiredProperty =
        DependencyProperty.Register(nameof(OldPasswordRequired), typeof(Visibility), typeof(ChangePassDialog));

    public static readonly DependencyProperty DialogNameIdentifierProperty =
        DependencyProperty.Register(nameof(DialogNameIdentifier), typeof(string), typeof(ChangePassDialog));
